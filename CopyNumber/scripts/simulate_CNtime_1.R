# even if I am running the model non in "validation mode"; I need to include in (data passed in prepare input data a column with tau and can be filled with 0 for example is I have no real value to compare them with)
...
for (i in (1:length(sim_list))) {
    ...
    for(i in 1:n_simulations){
      ...
      ggsave("./plots/simulation_plot.png", plot = simulation_plot, width = 10, height = 7,  device = png)
        ...
        # compute_external_metric = TRUE only if validation = true
